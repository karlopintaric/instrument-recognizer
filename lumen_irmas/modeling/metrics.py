...
def mean_f1_score(preds, targets):
    ...
    where a higher score indicates better prediction accuracy. The Mean F1 Score ranges from 0 to 1, with 1 being a perfect match.
...
def per_instr_f1_score(preds, targets):
    ...
    where a higher score indicates better prediction accuracy. The Per-Instrument F1 Score ranges from 0 to 1, with 1 being a perfect match.
